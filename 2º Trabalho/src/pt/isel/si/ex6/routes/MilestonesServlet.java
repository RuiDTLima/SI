...
import pt.isel.si.ex6.entities.Milestone;
...
public class MilestonesServlet extends RouteServlet {
    ...
    private static final String MILESTONE = load("./src/pt/isel/si/ex6/views/Milestone.html");
    private static final String MILESTONEROW = load("./src/pt/isel/si/ex6/views/MilestoneRow.html");
